...
/**
 * @ingroup od
 * @brief This structure contains all necessary informations to define a CANOpen
 * node
 */
...
#define CANOPEN_NODE_DATA_INITIALIZER(NODE_PREFIX)                             \
    {                              /* Object dictionary*/                      \
     ...
     {REPEAT_SDO_MAX_SIMULTANEOUS_TRANSFERS_TIMES(s_transfer_Initializer)},    \
                                                                               \
     /* State machine*/                                                        \
     Unknown_state, /* nodeState */ /* structure s_state_communication */      \
     {                                                                         \
         0, /* csBoot_Up */                                                    \
         0, /* csSDO */                                                        \
         0, /* csEmergency */                                                  \
     ...
     {REPEAT_NMT_MAX_NODE_ID_TIMES(                                            \
         NMTable_Initializer)}, /* is  well initialized at "Unknown_state". Is \
                                   it ok ? (FD)*/                              \
                                                                               \
     /* NMT-nodeguarding */                                                    \
     ...
     _storeODSubIndex, /* storeODSubIndex */ /* DCF concise */                 \
     NULL,                                   /*dcf_odentry*/                   \
     NULL,                                   /*dcf_cursor*/                    \
     1,                                      /*dcf_entries_count*/             \
     0,                                      /* dcf_status*/                   \
     ...
     sizeof(NODE_PREFIX##_obj1003) /                                           \
         sizeof(NODE_PREFIX##_obj1003[0]),     /* error_history_size */        \
     ...
     &NODE_PREFIX##_obj1014, /* error_cobid */ /* error_data: structure        \
                                                  s_errors */                  \
     {REPEAT_EMCY_MAX_ERRORS_TIMES(ERROR_DATA_INITIALIZER)},                   \
     _post_emcy, /* post_emcy */ /* LSS */                                     \
     lss_Initializer}
